        ...
        <div className="py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
          ...
          <div>
            <h4 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-4 flex items-center gap-1.5">
              <HomeIcon className="w-3 h-3" />Quick Links
            </h4>
            <div className="space-y-2">
              {quickLinks.map(link => (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`block text-xs transition-colors group ${isActive(link.href) ? 'text-primary font-medium' : 'text-muted-foreground hover:text-foreground'}`}
                >
          ...
          <div>
            <h4 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-4 flex items-center gap-1.5">
              <Globe className="w-3 h-3" />Profiles
            </h4>
